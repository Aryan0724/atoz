          ...
          <div className="mb-8 md:mb-0">
            <Link href="/" className="group flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="font-serif font-bold text-2xl tracking-tight text-white leading-none">ATOZ.</span>
                <div className="flex items-center gap-1 mt-1">
                  <div className="w-1 h-1 bg-brand-gold rounded-full"></div>
                  <span className="text-[7px] font-sans font-bold uppercase tracking-[0.2em] text-brand-gold">Excellence</span>
                </div>
              </div>
            </Link>
          </div>
          <div className="flex gap-8 text-[10px] font-sans font-bold uppercase tracking-widest text-slate-600">
            <span>© 2026 ATOZPRINTS</span>
